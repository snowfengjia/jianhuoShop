$(function(){
	...
	$('.banner').each(function(){
		...
		var jianhuoshops=e.attr("data-jianhuoshop");
		var jianhuoshops_s=e.attr("data-small");
		var jianhuoshops_m=e.attr("data-middle");
		var jianhuoshops_b=e.attr("data-big");
		var num=e.find(".carousel .jianhuoshop").length;
		var win=$(window).width();
		var i=1;

		if(interval==null){interval=5};
		if(jianhuoshops==null || jianhuoshops<1){jianhuoshops=1};
		if(jianhuoshops_s!=null && win>760){jianhuoshops=jianhuoshops_s};
		if(jianhuoshops_m!=null && win>1000){jianhuoshops=jianhuoshops_m};
		if(jianhuoshops_b!=null && win>1200){jianhuoshops=jianhuoshops_b};

		var jianhuoshopWidth=Math.ceil(e.outerWidth()/jianhuoshops);
		var page=Math.ceil(num/jianhuoshops);
		e.find(".carousel .jianhuoshop").css("width",jianhuoshopWidth+ "px");
		e.find(".carousel").css("width",jianhuoshopWidth*num + "px");
		
		var carousel=function(){
			i++;
			if(i>page){i=1;}
			$showbanner(e,i,jianhuoshops,num);
		};
		...
		if(pointer!=0 && page>1){
			...
			pager.find("li").click(function(){
				$showbanner(e,$(this).val(),jianhuoshops,num);
			});
	...
	$showbanner=function(e,i,jianhuoshops,num){
		var after=0,leftx=0;
		leftx = - Math.ceil(e.outerWidth()/jianhuoshops)*(jianhuoshops)*(i-1);
		if(i*jianhuoshops > num){after=i*jianhuoshops-num;leftx= - Math.ceil(e.outerWidth()/jianhuoshops)*(num-jianhuoshops);};
