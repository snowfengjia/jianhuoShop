...
<div class="panel admin-panel">
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="addGoods.do" enctype="multipart/form-data">  
      <div class="form-group">
        <div class="label">
          <label>名称：</label>
        </div>
        <div class="field">
          <input type="text" class="input w50" size="18" name="name" data-validate="required:请输入名称" />
          <input type="hidden" name="xnum" value="0">
          <div class="tips"></div>
        </div>
      </div>
       <div class="form-group">
        ...
        <div class="field">
        <textarea rows="10" cols="60" name="mark" class="input w50">
        </textarea>
          <div class="tips"></div>
        </div>
      </div>
     <div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" size="18" name="kcnum" data-validate="required:请输入数量" />
          <div class="tips"></div>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" size="18" name="price" data-validate="required:请输入总价" />
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
