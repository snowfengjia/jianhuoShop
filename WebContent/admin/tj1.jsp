...
<!-- <script type="text/javascript" src="/jianhuoshop/js/WdatePicker.js"></script> -->
<script src="/jianhuoshop/admin/js/FusionCharts.js"></script>
<script type="text/javascript" src="js/jquery-1.11.0.min.js"></script>
<script type="text/javascript" src="js/jquery-1.8.3.min.js"></script>
<!-- <script type="text/javascript" src="/jianhuoshop/admin/js/Date.js"></script> -->
<script type="text/javascript" src="/jianhuoshop//My97DatePicker/WdatePicker.js" charset="utf-8"></script>
    ...
    <div class="content">
        ...
        <div class="btn-toolbar">
					...
					<!-- 	<form action="tj1" method="post" class="form-inline"> -->
							<input class="input-xlarge" placeholder="开始时间..." id="key" onclick="WdatePicker()" name="starttime" type="text"  />
							
							<input class="input-xlarge" placeholder="截止时间..." id="key1"  onclick="WdatePicker()"  name="endtime" type="text"  ><!-- onclick="WdatePicker({dateFmt:'yyyy-MM-dd'});" -->
...
var chart = new FusionCharts("/jianhuoshopnew/admin/js/FCF_Line.swf", "ChartId", "900", "300");
